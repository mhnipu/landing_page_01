        ...
        <div className='md:px-14 px-4 py-16 max-w-screen-2xl mx-auto' id='service'>
            ...
            <div className='text-center my-8'>
                ...
                <div className='my-12 flex flex-wrap justify-between items-center gap-8'>
                    <img src="/src/assets/company_logos/1.png" alt="" className='hover:scale-95 transition-all duration-300' />
                    <img src="/src/assets/company_logos/2.png" alt="" className='hover:scale-95 transition-all duration-300' />
                    <img src="/src/assets/company_logos/3.png" alt="" className='hover:scale-95 transition-all duration-300' />
                    <img src="/src/assets/company_logos/4.png" alt="" className='hover:scale-95 transition-all duration-300' />
                    <img src="/src/assets/company_logos/5.png" alt="" className='hover:scale-95 transition-all duration-300' />
                    <img src="/src/assets/company_logos/6.png" alt="" className='hover:scale-95 transition-all duration-300' />
                    <img src="/src/assets/company_logos/7.png" alt="" className='hover:scale-95 transition-all duration-300' />
                </div>
                {/*  service card */}
                ...
                <div className='mt-14 mb-10 grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 md:w-11/12 mx-auto gap-12'>
                    {
                        ...
                        mx-auto md:h-80 rounded-md shadow cursor-pointer hover:translate-y-2 hover:border-b-4  hover:border-televersantBlue hover:scale-95 transition-all duration-300 flex items-center justify-center h-full'>
                            <div>
                                <div className='bg-[#c8e2f7] mb-4 h-14 w-14 mx-auto rounded-tl-3xl rounded-br-3xl'><img src={service.Image} alt="" className='-ml-5 hover:scale-95 transition-all duration-300' /></div>
